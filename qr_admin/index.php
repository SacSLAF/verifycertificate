...
switch ($msg) {
    ...
    case 'recaptcha-failed':
        $message = 'Recaptcha verification is failed. Try again.';
        break;
    default:
        $message = '';
        break;
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // if ($responseKeys["success"] && $responseKeys["score"] >= 0.75) {
    ...
    // } else {
        // header("Location: index.php?msg=recaptcha-failed");
    // }
...
<body>
    <div class="wrapper">
        ...
        <?php endif; ?>
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" id="qr-login">
    ...
    <script>
        ...
        document.getElementById('qr-login').addEventListener('submit', onSubmit);
    </script>
</body>
